...
public class DumbAIPlayer extends AIPlayer {
    ...
    public DumbAIPlayer(String name, GuessWhoCharacter secret) {
        ...
        // This guarantees a) no question is asked twice, b) all questions are in the
        // bank.
     ...
     * @implSpec The current implementation asks all the questions in the question
     *           bank, one by one in a randomized order.
     *           If it is able to find exactly one remaining item, it asks for that
     *           item.
     */
    @Override
