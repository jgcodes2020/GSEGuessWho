...
/**
 * An extension of {@link JPanel} that can be constrained along the X and/or Y axes when placed in a {@link JScrollPane}.
 * The 'G' prefix represents both its authorship (GSE) and its genericity compared to other components that were created
 * for this project.
 */
public class GScrollConstrainedPanel extends JPanel implements Scrollable, SwingConstants {
	// These two properties are named after their respective getters in the Scrollable interface.
	 ...
	 * @param trackViewportWidth If true, this panel's width will be locked to that of its viewport.
	 * @param trackViewportHeight If true, this panel's height will be locked to that of its viewport.
	 */
	...
	/**
	 * Returns the preferred scroll viewport size for this scroll-constrained panel. As recommended in
	 * the official docs for {@code Scrollable}, this simply returns the panel's preferred size.
	...
	/**
	 * Checks whether this scroll-constrained panel's width should be locked to that of its viewport.
	...
	/**
	 * Sets whether this scroll-constrained panel's height should be locked to that of its viewport.
	 * @param value If true, this panel's width will be locked to that of its viewport.
	 */
	...
	/**
	 * Sets whether this scroll-constrained panel's width should be locked to that of its viewport.
	 * @param value If true, this panel's height will be locked to that of its viewport.
	 */
	...
	/**
	 * Gets the distance to scroll when the user requests a "block scroll" (e.g. Page Up/Page Down keys).
	 ...
	 * @param direction Less than 0 for up or left, greater than 0 for down or left.
	 */
	@Override
