...
/**
 * Panel displayed to show a logical contraiditon has happened. Also has a button
 * to save the game's history; useful for testing and debugging.
 */
public class LogicalContraditionPanel extends JPanel {
	...
	/**
	 * Sets up a logical contradition panel.
	 * 
	 * @param mainWindow the main window to link with this logical contradition panel
	 */
	public LogicalContraditionPanel(MainWindow mainWindow) {
		main = mainWindow;
	...
	private void onSaveLogPressed(ActionEvent e) {
		...
		try {
			...
			JOptionPane.showMessageDialog(this.getTopLevelAncestor(),
					"An error occurred saving the file! Try again...");
		}
	}
}
